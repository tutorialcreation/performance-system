...
class KpiGroups(models.Model):
    ...
    members = models.ManyToManyField(KpiIndividual, through='KpiMembership')
...
class KpiMembership(models.Model):  # intermediate model
    individual = models.ForeignKey(KpiIndividual, on_delete=models.CASCADE)  # source models
    group = models.ForeignKey(KpiGroups, on_delete=models.CASCADE)  # source models
    effective_date_joined = models.DateField(null=True)
    # effective_date_removed = models.DateField(null=True)
...
class KpiValue(models.Model):
    ...
    group = models.ForeignKey(KpiGroups, on_delete=models.SET_NULL, related_name='kpi_group', null=True, blank=True)
    indicator = models.BooleanField(default=False)
    value = models.FloatField(null=True)
    period_date = models.DateField(auto_now_add=True, null=True, blank=True)
...
class KpiValues(KpiValueMain, MPTTModel):
    ...
    group = models.ForeignKey(KpiGroups, on_delete=models.SET_NULL, related_name='kpi_groupset', null=True, blank=True)
    parent = TreeForeignKey('self', on_delete=models.CASCADE, null=True, blank=True,
    ...
    class MPTTMeta:
        ...
        order_insertion_by = ['period_date']
