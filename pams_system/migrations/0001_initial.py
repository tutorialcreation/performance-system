# Generated by Django 2.2.7 on 2020-02-26 11:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_date', django.contrib.postgres.fields.ArrayField(base_field=models.DateTimeField(), null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kpi_assign', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='kpi_assign', to='pams_system.InputData', verbose_name='Datastructure:')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kpi_ind_val', to='pams_system.KpiIndividual', verbose_name='Participants')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kpis', models.CharField(max_length=50, null=True)),
                ('weights', models.IntegerField(null=True)),
                ('value_date', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.DateTimeField(), size=20), size=20)),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('number_of_levels', models.PositiveIntegerField(editable=False)),
